...
export const ui = {
  ru: {
    ...
    articlesIntro: 'Каждая статья — это тот же узел, который виден в Хроно и на карте Связей: полный разбор, сильные возражения, ограничения и документы для проверки.',
  ...
  en: {
    ...
    articlesTitle: 'One library of questions, events, and arguments', articlesIntro: 'Every article is the same node shown in Chrono and Connections: a full analysis with strong objections, limits, and documents to verify.',
  ...
  uk: {
    ...
    articlesTitle: 'Єдина бібліотека питань, подій та аргументів', articlesIntro: 'Кожна стаття — це той самий вузол, який видно у Хроно та на мапі Зв’язків: повний розбір, сильні заперечення, обмеження й документи для перевірки.',
