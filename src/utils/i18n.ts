...
export const ui = {
  ...
  en: {
    chrono: 'Chrono', connections: 'Connections', arguments: 'Arguments', argument: 'Argument', ai: 'AI', pro: 'PRO', theme: 'Toggle theme', language: 'Language',
  ...
  uk: {
    chrono: 'Хроно', connections: 'Зв’язки', arguments: 'Аргументи', argument: 'Аргумент', ai: 'AI', pro: 'PRO', theme: 'Перемкнути тему', language: 'Мова',
