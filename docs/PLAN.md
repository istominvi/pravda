...
BAZA должна быть вторым экраном во время живого политического разговора. Пользователь не читает длинный доклад заранее: он слышит тезис, за несколько секунд находит нужный узел, видит первичный документ, возможные продолжения разговора и границы корректного вывода.
...
BAZA предлагает варианты, но не публикует сообщения и не говорит вместо пользователя. Желательные режимы ответа:
...
- событие → связи;
- узел графа → статья события или документа;
- AI-тема → узел графа;
...
Когда эта цепочка работает с низкой задержкой и проверяемыми citations, BAZA превращается из справочника в полноценный рабочий инструмент живого разговора.
